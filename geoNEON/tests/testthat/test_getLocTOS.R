...
test_that("Select bird named locations are correct", {
  ...
  expect_equal(as.numeric(out$northing), c(4308017.759165, 4880714.9041744, 4880464.93234, 4881510.4750), tolerance=0.1)
...
test_that("Select smammal named locations are correct", {
  ...
  expect_equal(as.numeric(out$northing), c(4879827.13675762, NA, 4879827.1367), tolerance=1)
