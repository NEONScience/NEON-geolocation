...
test_that("GUAN_044.basePlot.ltr location values are correct", {
  ...
  expect_equal(out$api.description, c('Plot \"GUAN_044\" at site \"GUAN\"', 'Plot \"GUAN_045\" at site \"GUAN\"'))
  expect_equal(as.numeric(out$api.northing), c(1987798.71019852, 1988068.47644692))
})
